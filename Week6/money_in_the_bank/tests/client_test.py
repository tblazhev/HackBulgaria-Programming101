...
class ClientTests(unittest.TestCase):
    ...
    def setUp(self):
        self.test_client = Client(1, "Ivo", "ivo@hackbulgaria.com", 200000.00, "Bitcoin mining makes me rich")
    ...
    def test_client_email(self):
        self.assertEqual(self.test_client.get_email(), "ivo@hackbulgaria.com")
